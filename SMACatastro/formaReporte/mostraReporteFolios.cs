...
{
    public partial class mostraReporteFolios : Form
    {
        ...
        private DataTable ObtenerDatosOrdenSP(DateTime fechaInicio, DateTime fechaFin)
        {
            ...
            con.open_c_interno();
            SqlCommand cmd = new SqlCommand("SP_REPORTE_TRAMITES", con.cnn_interno); //NOMBRE DEL PROCEDIMIENTO ALMACENADO 
        ...
        private void mostraReporteFolios_Load(object sender, EventArgs e)
            {
            ...
            reportViewer1.LocalReport.DisplayName = "REPORTE DE TRAMITES";
            reportViewer1.SetDisplayMode(DisplayMode.PrintLayout);
            //OBTENER DATOS DE LA BASE DE DATOS
            DataTable dtDetalle = ObtenerDatosOrdenSP(fechaInicio, fechaFin); //datos para el procedimiento almacenado 
            reportViewer1.LocalReport.ReportEmbeddedResource = "SMACatastro.formaReporte.reporteFoliosPendientesAutorizados.rdlc"; //indicar la ruta y que se le va a poner     
